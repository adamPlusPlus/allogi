...
export default function RecursiveLogsPage({ serverUrl, autoRefresh, refreshInterval }: RecursiveLogsPageProps) {
  ...
  return (
    <div className="recursive-logs-page">
      ...
      {/* Stats */}
      <div className="recursive-logs-stats">
        <div className="stat-card">
          <div className="stat-number">{stats.totalRecursiveLogs}</div>
          <div className="stat-label">Total Recursive Logs</div>
        </div>
        <div className="stat-card">
          <div className="stat-number">{Object.keys(stats.byScript).length}</div>
          <div className="stat-label">Self-Logging Scripts</div>
        </div>
        <div className="stat-card">
          <div className="stat-number">{Object.keys(stats.byLevel).length}</div>
      ...
      <div className="recursive-logs-content">
        {/* Left Column - Table View (like Monitoring) */}
        <div className="recursive-logs-table-column">
          <div className="recursive-logs-table-header">
            <h3>📊 Recursive Logs Table</h3>
            <button 
              className="refresh-btn"
              onClick={fetchRecursiveLogs}
          ...
          <div className="recursive-logs-table">
            <table>
              <thead>
                <tr>
                  <th 
              ...
              <tbody>
                {sortedTableData.length === 0 ? (
                  ...
                  sortedTableData.map((log) => (
                    ...
                    >
                       <td className="table-script" style={{ color: getScriptColor(log.scriptId) }}>
                         {log.scriptId || 'unknown'}
                      </td>
                      <td>
                        <span 
